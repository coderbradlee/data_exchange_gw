#ifndef ORDERBOT_RESTSERVER_RESOURCE_HPP
#define	ORDERBOT_RESTSERVER_RESOURCE_HPP

#include "orderbot_restserver.hpp"
void orderbot_server_start()
{
	/////////////////////////////////////////////////////////
		...
		//get_orders_param->set_path("/admin/orders.json/{name: [\\?].*}");
...
//http://172.18.100.85:8688/admin/account.json/
		...
		get_account_num->set_path("/admin/accounts.json/{name: ([0-9]+)}");
		...
		get_account_param->set_path("/admin/accounts.json/");
