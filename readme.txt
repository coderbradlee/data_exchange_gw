...
curl -u test:test -X GET http://172.18.100.85:8988/exchange_rate/?source=TWD\&target=CNY\&time=2016-06-30\&database=js

curl -u test:test -X GET http://172.18.100.85:8988/exchange_rate/?source=CNY\&target=JPY\&time=2016-06-30\&database=js

curl -u test:test -X GET http://172.18.100.85:8988/exchange_rate/?source=JPY\&target=CNY\&time=2016-06-30\&database=js
...
////////////////////////////////////////////////////////////////////////
curl -u test:test -X GET http://172.18.100.85:8988/exchange_rate/?source=CNY\&target=GBP\&time=2016-06-30\&database=js
curl -u test:test -X POST http://172.18.100.85:8988/exchange_rate/?source=CNY\&target=GBP\&time=2016-06-30\&ratio=0.112273\&database=js

curl -u test:test -X GET http://172.18.100.85:8988/exchange_rate/?source=CNY\&target=HKD\&time=2016-06-30\&database=js
curl -u test:test -X POST http://172.18.100.85:8988/exchange_rate/?source=CNY\&target=HKD\&time=2016-06-30\&ratio=1.169189\&database=js


curl -u test:test -X GET http://172.18.100.85:8988/exchange_rate/?source=CNY\&target=TRY\&time=2016-06-30\&database=js
curl -u test:test -X POST http://172.18.100.85:8988/exchange_rate/?source=CNY\&target=TRY\&time=2016-06-30\&ratio=0.435394\&database=js
